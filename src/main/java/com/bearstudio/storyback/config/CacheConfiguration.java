package com.bearstudio.storyback.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bearstudio.storyback.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bearstudio.storyback.repository.UserRepository.USERS_BY_EMAIL_CACHE);
